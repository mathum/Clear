...
public class StateInterCutVersion extends PrisonBaseVersion {
    ...
    public void init(int remoteVersion, Context ctx,
        ...
        versionUrl = ClearConfig.SERVER_URI + ClearConstant.STR_BACKEND_PORT + ClearConstant.URL_STATE_INTER_CUT_SUFFIX;
    }

    @Override
    protected void initSharedPreferences() {
        // TODO Auto-generated method stub
        mSharedPreferences = mContext.getSharedPreferences(ClearConstant.STR_STATE_INTER_CUT, Context.MODE_PRIVATE);
    }
